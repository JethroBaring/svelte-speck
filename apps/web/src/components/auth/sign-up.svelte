<script lang="ts">
	...
	import { ChevronLeftIcon, EyeIcon, EyeClosedIcon } from 'lucide-svelte';
...
<div class="no-scrollbar flex w-full flex-1 flex-col overflow-y-auto lg:w-1/2">
					...
					<div class="space-y-5">
						<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
							<div class="sm:col-span-1">
								...
								<Input
									...
									onChange={(e) => (firstName = (e.target as HTMLInputElement).value)}
									required
								/>
							</div>
							<div class="sm:col-span-1">
								...
								<Input
									...
									onChange={(e) => (lastName = (e.target as HTMLInputElement).value)}
									required
								/>
							</div>
						</div>
						...
						<div class="flex items-center gap-3">
							<Checkbox
								...
								onChange={() => (agreeToTerms = !agreeToTerms)}
							/>
