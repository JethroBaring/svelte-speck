...
<div class="relative">
	<button
		...
		class="dropdown-toggle flex items-center text-gray-700 dark:text-gray-400"
	>
		<span class="mr-3 h-10 w-10 overflow-hidden rounded-full">
			<img width={44} height={44} src="/images/user/owner.jpg" alt="User" />
		</span>

		<span class="mr-1 block text-theme-sm font-medium">John Doe</span>
